...
| `smoke:web:sprint9` | `sprint9-smoke-web.ps1` | Alias — Sprint 9 web smokes (credit + rewrite) | Same; `-- -IncludeApiMode` for API rewrite E2E (needs `VITE_USE_MOCKS=false` + `AI_GENERATION_ENABLED=true` for success path) |
