...
| `scripts` | **Smoke scripts (2.15, 3.8, 4.7–4.8, 5.6, 6.6)** | `smoke:api`, `smoke:api:sprint6`, `smoke:web`, `smoke:web:outline`, `smoke:web:write`, `smoke:web:summary` — see `scripts/README.md` |
