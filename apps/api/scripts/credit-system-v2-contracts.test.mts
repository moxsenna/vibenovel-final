await import("./credit-policy-v2-contracts.test.mts");
await import("./credit-ledger-v2-contracts.test.mts");
...
await import("./credit-generation-matrix-contracts.test.mts");
await import("./generation-contracts.test.mts");

console.log("PASS complete Credit System v2 API contract suite");
